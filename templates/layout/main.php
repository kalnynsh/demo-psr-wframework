...
<head>
    ...
    <?= $this->blockRender('meta') ?>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.0/dist/css/bootstrap.min.css"
      rel="stylesheet" integrity="sha384-KyZXEAg3QhqLMpG8r+8fhAXLRk2vvoC2f3B09zVXn8CA5QIVfZOJ3BCsw2P0p/We"
      crossorigin="anonymous" />
    <link href="/images/house-237998/favicon.ico"
      rel="shortcut icon" type="image/ico"  />
    <title>
      <?= $this->blockRender('title'); ?>
    </title>
</head>
<body>
  ...
  <div class="h-100">
    ...
    <?= $this->blockRender('topNavbar'); ?>

    <?= $this->blockRender('content'); ?>
    ...
    <div class="bg-light px-4">
      <footer class="footer mt-auto d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        ...
        <div class="col-md-4 d-flex align-items-center">
          <a href="<?= $this->encode($this->path('home')) ?>" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
            <svg class="bi" width="30" height="24"><use xlink:href="#bootstrap"></use></svg>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 64 64" width="30px" height="24px">
          ...
          <span class="text-muted">&copy; <?= \date('Y'); ?> PSR-7 Demo</span>
        </div>
